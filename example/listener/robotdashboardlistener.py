...
# usage:
# robot --listener path/to/robotdashboardlistener.py:output=path/to/output.xml:tags=tag1,tag2 path/to/tests.robot

# most basic usage:
# robot --listener robotdashboardlistener.py:output=./results/output.xml tests.robot
# with run tags (comma separated):
# robot --listener robotdashboardlistener.py:output=./results/output.xml:tags=prod,dev tests.robot
# with changed server host/port:
# robot --listener robotdashboardlistener.py:output=./results/output.xml:tags=prod,dev:host=127.0.0.2:port=8544 tests.robot

class robotdashboardlistener:

    def __init__(self, output: str, tags: str = None, host: str = "127.0.0.1", port: str = "8543"):
        self.output = output
        self.host = host
        self.port = port
